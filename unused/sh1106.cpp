...
//#define OLED_SDA PICO_DEFAULT_I2C_SDA_PIN
#define OLED_SDA 16
#define OLED_SCL 17
...
void sh1106_lcd::Initialize()
{
    ...
    bi_decl(bi_2pins_with_func(OLED_SDA, OLED_SCL, GPIO_FUNC_I2C));
...
//        Wire.write(SH1106_COMMAND);
        i2c_write_blocking(OLED_i2c, SH1106_ADDR1 , SH1106_COMMAND, 1, false);
...
//        Wire.write(SH1106_DATA);
        i2c_write_blocking(OLED_i2c, (SH1106_ADDR1)  , reinterpret_cast<const uint8_t *>(SH1106_DATA), 1, false);
...
{
//    Wire.write(data);
    i2c_write_blocking(OLED_i2c, (SH1106_ADDR1)  , reinterpret_cast<const uint8_t *>(&data), 1, false);
